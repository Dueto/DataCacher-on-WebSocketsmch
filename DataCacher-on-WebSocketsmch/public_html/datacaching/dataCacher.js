(function(window)
{
    var dataCacher = function()
    {
                ...
                onEndCallBack)
        {
            ...
            self.dataHandl.setOnEndOfWorkCallback(self.onReadyFormingData.bind(self));

            self.webSocket.setOnMessageCallback(self.dataHandl.onMessageRecieved.bind(self.dataHandl));
